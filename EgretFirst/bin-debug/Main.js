...
var Main = (function (_super) {
    ...
    Main.prototype.createChildren = function () {
        ...
        //     console.log(e);
        // })
        this.myRunGame().catch(function (e) {
            console.log(e);
        });
    };
    ////练习代码
    Main.prototype.myRunGame = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.loadResource()];
                    case 1:
                        _a.sent(); //加载在default.res.json文件中配置的资源信息
    ...
    //轻触事件
    Main.prototype.onBgTouchTap = function (e) {
        console.log("onBgTouchTap");
        console.log(e.stageX + e.stageY);
    };
    //移动
    Main.prototype.onBgTouchMove = function (e) {
        console.log("onBgTouchMove");
    };
    //触摸开始
    Main.prototype.onBgTouchBegin = function (e) {
        console.log("onBgTouchBegin");
    };
    //触摸结束
    Main.prototype.onBgTouchEnd = function (e) {
